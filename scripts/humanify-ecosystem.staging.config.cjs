...
const APP_DIR = process.env.HUMANIFY_APP_DIR || '/root/humanify-staging';
const PORT = Number(process.env.HUMANIFY_PORT || 3021);
const PM2_HOME = process.env.PM2_HOME || `${process.env.HOME || '/root'}/.pm2`;
const APP_NAME = process.env.HUMANIFY_PM2_NAME || 'humanify-staging';
