...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
      ...
      switch (action) {
        ...
        case 'download-template': {
          ...
          return res.json({
            ...
            data: {
              ...tpl,
              downloadUrl: `/api/humanify/project-documents?action=generate-template&id=${tpl.id}`,
    ...
    console.warn('Project Documents API error: (table may not exist):', (error as any)?.message || error);
