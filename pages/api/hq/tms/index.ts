...
const q = async (sql: string, replacements?: any) => {
  ...
  catch (e: any) { console.warn('TMS Q: (table may not exist):', e.message); return []; }
};
...
const qExec = async (sql: string, replacements?: any) => {
  ...
  catch (e: any) { console.warn('TMS Exec: (table may not exist):', e.message); return false; }
};
...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    console.warn('TMS API error: (table may not exist):', (error as any)?.message || error);
