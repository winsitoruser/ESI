...
const MODULE_REGISTRY: ModuleInfo[] = [
  ...
  { code: 'humanify', name: 'Humanify', description: 'Platform SDM, payroll & workforce', icon: UserCheck, href: '/humanify', gradient: 'from-violet-500 to-fuchsia-600', iconColor: 'text-violet-600', category: 'hr' },
