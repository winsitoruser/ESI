    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-violet-50 via-white to-slate-50">
        ...
        <main className="max-w-3xl mx-auto px-4 pb-16">
          <Link href="/humanify/welcome" className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-slate-800 mb-6">
          ...
          {done ? (
            <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-8 text-center">
              ...
              <Link href="/humanify/welcome" className="inline-block mt-4 text-sm text-violet-700 font-medium hover:underline">
                Ke beranda Humanify
              </Link>
            </div>
          ) : (
            <form onSubmit={submit} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <label className="block text-sm">
                  <span className="text-slate-600">Telepon / WhatsApp</span>
                  <input
                    value={form.phone}
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <label className="block text-sm">
                  <span className="text-slate-600">Jenis mitra</span>
                  <select
          ...
          <p className="text-xs text-slate-400 mt-6">
            ...
            <Link href="/humanify/pricing/roi-calculator" className="text-violet-600 hover:underline">kalkulator</Link>
          </p>
        </main>
      </div>
    </>
