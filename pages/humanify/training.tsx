...
export default function TrainingPage() {
  ...
  async function handleCreateProgram(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const res = await fetch('/api/humanify/training?action=create-program', {
  ...
  async function handleDeleteProgram(id: string) {
    ...
    try {
      const res = await fetch(`/api/humanify/training?action=delete-program&id=${id}`, { method: 'DELETE' });
      const data = await res.json();
