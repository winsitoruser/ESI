...
export default function AttendanceManagementPage() {
  ...
  const handleSaveShift = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/humanify/attendance-management?action=shift', { method: isEdit ? 'PUT' : 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) });
      const json = await res.json();
  ...
  const handleDeleteShift = async (id: string) => {
    ...
    try {
      const res = await fetch(`/api/humanify/attendance-management?action=shift&id=${id}`, { method: 'DELETE' });
      const json = await res.json();
  ...
  const handleSaveGeo = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/humanify/attendance-management?action=geofence', { method: isEdit ? 'PUT' : 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) });
      const json = await res.json();
  ...
  const handleDeleteGeo = async (id: string) => {
    ...
    try {
      const res = await fetch(`/api/humanify/attendance-management?action=geofence&id=${id}`, { method: 'DELETE' });
      const json = await res.json();
  ...
  const handleDeleteRotation = async (id: string) => {
    ...
    try {
      const res = await fetch(`/api/humanify/attendance-management?action=rotation&id=${id}`, { method: 'DELETE' });
  ...
  const handleGenerateRotation = async (id: string) => {
    try {
      const res = await fetch('/api/humanify/attendance-management?action=generate-rotation', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ rotationId: id }) });
      const json = await res.json();
  ...
  const handleSaveSetting = async (key: string, value: any) => {
    try {
      const res = await fetch('/api/humanify/attendance-management?action=settings', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ key, value }) });
      const json = await res.json();
