  ...
  return (
    <HQLayout title="HR Analytics" subtitle="Insight SDM real-time — lebih lengkap dari dashboard HRIS standar">
      <div className="space-y-6">
        {/* Hero */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-indigo-950 to-violet-900 p-6 text-white shadow-xl md:p-8">
        ...
        <div className="flex gap-1 overflow-x-auto border-b">
          {tabs.map(t => (
            <button key={t.key} onClick={() => setTab(t.key)}
              className={`flex items-center gap-1.5 whitespace-nowrap border-b-2 px-4 py-2.5 text-sm font-medium transition ${tab === t.key ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700'}`}>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-2xl border bg-white p-6 shadow-sm lg:col-span-3">
              ...
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
                {quickLinks.map(l => (
                  <Link key={l.href} href={l.href} className="group flex flex-col items-center gap-2 rounded-xl border p-4 transition hover:border-indigo-200 hover:shadow-md">
                    <div className={`rounded-xl p-2.5 ${l.color}`}><l.icon className="h-5 w-5" /></div>
                    <span className="text-sm font-medium text-gray-700 group-hover:text-indigo-600">{l.label}</span>
                    <ChevronRight className="h-3 w-3 text-gray-300 group-hover:text-indigo-400" />
                  </Link>
                ))}
              </div>
            </div>
        ...
        {!loading && tab === 'attendance' && (
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <Link href="/humanify/attendance" className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-indigo-600 hover:underline">
            ...
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <Link href="/humanify/payroll/lembur" className="mt-2 inline-flex items-center gap-1 text-sm font-medium text-indigo-600 hover:underline">
        ...
        {!loading && tab === 'performance' && (
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-3">
                <div className="flex items-center justify-between rounded-xl bg-indigo-50 p-4">
                  <span className="text-sm text-indigo-700">Review Selesai</span>
                  <span className="text-2xl font-bold text-indigo-900">{data.performance.completed}/{data.performance.total}</span>
                </div>
              ...
              <Link href="/humanify/performance" className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-indigo-600 hover:underline">
            ...
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <Link href="/humanify/kpi" className="mt-2 inline-flex items-center gap-1 text-sm font-medium text-indigo-600 hover:underline">
        ...
        {!loading && tab === 'payroll' && (
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <Link href="/humanify/reimbursement" className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-indigo-600 hover:underline">
              ...
              {aiInsights.map((ins: any, i: number) => (
                <div key={i} className="rounded-2xl border bg-white p-5 shadow-sm">
                  <div className="flex items-start justify-between">
                    <span className="rounded-full bg-indigo-100 px-2.5 py-0.5 text-xs font-medium capitalize text-indigo-700">{ins.module}</span>
                  ...
                  <ul className="mt-3 space-y-1">
                    {(ins.actions || []).map((a: string, j: number) => (
                      <li key={j} className="flex items-center gap-1.5 text-xs text-indigo-600"><ChevronRight className="h-3 w-3" />{a}</li>
                    ))}
                  </ul>
                </div>
              ))}
        ...
        {!loading && tab === 'recruitment' && (
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <Link href="/humanify/recruitment" className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-indigo-600 hover:underline">
            ...
            <div className="rounded-2xl border border-indigo-100 bg-gradient-to-br from-indigo-50 to-violet-50 p-6">
              <h3 className="font-semibold text-indigo-900">Keunggulan vs Kompetitor</h3>
