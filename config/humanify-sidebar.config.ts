      ...
      items: [
        ...
        { id: 'humanify-careers', name: 'Portal Karir Publik', href: '/careers', icon: Globe, modules: ['humanify', 'hris'] },
        {
          ...
          children: [
            ...
            { id: 'humanify-lms-integrations', name: 'Integrasi Ekosistem', href: '/humanify/lms/integrations', icon: Network, modules: ['humanify', 'hris'] },
            { id: 'humanify-lms-academy', name: 'Academy & Eksternal', href: '/humanify/lms/academy', icon: Globe, modules: ['humanify', 'hris'] },
            { id: 'humanify-lms-ai', name: 'AI Assistant', href: '/humanify/lms/ai-assistant', icon: Sparkles, modules: ['humanify', 'hris'] },
